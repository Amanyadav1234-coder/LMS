...
<html
  ...
  <head>
    ...
    <title>Student Dashboard - Home Pages</title>
                    ...
                    <div class="d-flex align-items-end row">
                      <div class="col-sm-7">
                        <div class="card-body">
                          ...
                          <h5 class="card-title text-primary">Hello Student</h5>
                          <p class="mb-4">
                            You have done <span class="fw-medium">72%</span> more 
                            syllabus today. Check your new badge in
                            your profile.
                          </p>
                    ...
                    <div class="col-lg-6 col-md-12 col-6 mb-4">
                      <div class="card">
                        <div class="card-body">
                          ...
                          <span class="fw-medium d-block mb-1">Your Course</span>
                ...
                <div class="col-12 col-lg-8 order-2 order-md-3 order-lg-2 mb-4">
                  <div class="card">
                    <div class="row row-bordered g-0">
                      <div class="col-md-8">
                        <h5 class="card-header m-0 me-2 pb-3">Total Attendance</h5>
                      ...
                      <div class="col-md-4">
                        ...
                        <div class="text-center fw-medium pt-3 mb-2">62% Attendance</div>
