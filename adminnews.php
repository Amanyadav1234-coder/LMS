          ...
          <form action="" method="post">
            <div class="row">
              <div class="col">
                ...
                <textarea name="news" id=""rows="3" class="form-control my-2"></textarea>
              </div>
            </div>
            <div class="row my-4">
              <div class="col">
                <label for="">Enter Your Name:</label>
                <input type="text" name="tname" id="" class="form-control my-1">
              </div>
            </div>
            <div class="row">
              <div class="col">
                <input type="submit" name="sub" id="" class="form-control btn btn-outline-primary  mb-5" name="sub" value="sub">
              </div>
            </div>
          </form>
        </div>
