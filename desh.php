...
<html
  ...
  <head>
    ...
    <title>Admin Dashboard - Home Pages</title>
                    ...
                    <div class="col-lg-6 col-md-12 col-6 mb-4">
                      <div class="card">
                        <div class="card-body">
                          ...
                          <span class="fw-medium d-block mb-1">Total Student</span>
                          <h3 class="card-title mb-2">1200+</h3>
                  ...
                  <div class="card">
                    <div class="row row-bordered g-0">
                      ...
                      <div class="col-md-4">
                        ...
                        <div class="text-center fw-medium pt-3 mb-2">62%  Growth</div>
